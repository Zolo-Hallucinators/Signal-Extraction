...
_A Snowflake-powered end-to-end machine learning pipeline for financial signal generation and prediction._
...
This project was developed as part of the **Snowflake Hackathon**, and secured a **Runner‑Up** position by building a complete **data ingestion → transformation → prediction → visualization** pipeline.
...
- **Hackathon Mentors** and collaborators for their support ([Snowflake - The Dev Premier League](https://vision.hack2skill.com/event/gcc-dev-premier-league-2025))

---

⭐ _If you like this project, give it a star on GitHub — your support keeps it growing!_
